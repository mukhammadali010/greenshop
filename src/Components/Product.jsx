...
export const Product = () => {
  return (
    <div className='max-w-screen-xl mx-auto py-8 flex gap-x-10'>
      <div className='flex-1 space-y-6'>
        <div>
          <h2 className='text-[17px] text-[#3D3D3D] font-bold'>Home / Shop / Checkout</h2>
          <h2 className='text-[17px] text-[#3D3D3D] font-bold mt-4'>Billing Address</h2>
        </div>
        ...
        <div className='flex gap-4'>
          <div className='flex flex-col w-[350px]'>
            ...
            <select className='h-[40px] rounded-[3px] border border-gray-300 outline-none indent-3 text-[14px] text-[#A5A5A5]' defaultValue="">
              <option value="" disabled hidden>Select a country / region</option>
        ...
        <div className='flex gap-4'>
          <div className='flex flex-col w-[350px]'>
            ...
            <input type="text" placeholder="Street name and house number" className='h-[40px] mb-2 rounded-[3px] border border-gray-300 outline-none indent-3' />
          </div>
          <div className='flex flex-col w-[350px] mt-[24px]'>
            <input type="text" placeholder="Apartment, suite, etc. (optional)" className='h-[40px] rounded-[3px] border border-gray-300 outline-none indent-3' />
          </div>
        </div>
        ...
        <div className='flex gap-4'>
          ...
          <div className='flex flex-col w-[350px]'>
            ...
            <select className='h-[40px] rounded-[3px] border border-gray-300 outline-none indent-3 text-[14px] text-[#A5A5A5]' defaultValue="+966">
              <option value="+966" className="text-black">+966</option>
              <option value="+998" className="text-black">+998 (Uzbekistan)</option>
        ...
        <label className='text-[17px] text-[#3D3D3D] font-bold flex items-center gap-2'>
          <input type="checkbox" className='appearance-none w-[15px] h-[15px] rounded-full border-2 border-[#46A358] checked:bg-[#46A358]' />
      ...
      <div className='w-[420px] space-y-4'>
        ...
        <div className='flex items-center bg-[#FBFBFB] w-full h-[70px] px-2 justify-between'>
          <img src={pic} alt="" className='w-[50px] h-[50px] object-contain' />
          <div className='flex-1 ml-4'>
            <h4 className='text-[#3D3D3D] text-[16px] font-bold'>Barberton Daisy</h4>
            <p className='text-[14px] text-[#727272]'>SKU: 1995751877966</p>
          </div>
          <span className='text-[18px] text-[#46A358]'>$238.00</span>
        </div>

        <div className='flex items-center bg-[#FBFBFB] w-full h-[70px] px-2 justify-between'>
          <img src={pic2} alt="" className='w-[50px] h-[50px] object-contain' />
          <div className='flex-1 ml-4'>
            <h4 className='text-[#3D3D3D] text-[16px] font-bold'>Blushing Bromeliad</h4>
            <p className='text-[14px] text-[#727272]'>SKU: 19957518757065</p>
          </div>
          <span className='text-[18px] text-[#46A358]'>$834.00</span>
        </div>

        <div className='flex items-center bg-[#FBFBFB] w-full h-[70px] px-2 justify-between'>
          <img src={pic3} alt="" className='w-[50px] h-[50px] object-contain' />
          <div className='flex-1 ml-4'>
            <h4 className='text-[#3D3D3D] text-[16px] font-bold'>Aluminum Plant</h4>
            <p className='text-[14px] text-[#727272]'>SKU: 1995751877786</p>
          </div>
